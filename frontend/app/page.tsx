            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  A modern todo application with authentication to help you organize your life and boost productivity.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="h-56 w-full bg-primary-100 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg shadow-lg w-4/5">
              <h3 className="text-lg font-medium text-gray-900 mb-2">Sample Task</h3>
              <p className="text-gray-500">Try out our task management features with a free account</p>
            </div>
          </div>
        </div>
      </div>
